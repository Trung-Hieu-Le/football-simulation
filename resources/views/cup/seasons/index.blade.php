...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1>Cup Seasons</h1>
    <div>
        <form action="{{ route('cup.seasons.destroy-all') }}" method="POST" class="d-inline">
            @csrf
            <button type="submit" class="btn btn-danger" onclick="return confirm('Delete all Cup seasons?')">Delete All</button>
        </form>
